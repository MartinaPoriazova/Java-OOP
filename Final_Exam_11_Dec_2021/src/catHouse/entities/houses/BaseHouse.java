...
public abstract class BaseHouse implements House {
    ...
    public void addCat(Cat cat) {
        ...
        String houseType = cat.getClass().getSimpleName().replaceAll("hairCat", "");

        if (!this.getClass().getSimpleName().contains(houseType)) {
    ...
    public String getStatistics() {
        ...
        return String.format("%s %s:%n" +
                        ...
                        "Toys: %d " +
                        "Softness: %s",
                name, this.getClass().getSimpleName(), catsOut, toys.size(), sumSoftness());
    }
